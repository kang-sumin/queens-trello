...
public class CommentController {
    ...
    //댓글 작성
    @PostMapping
    public ResponseEntity<CommentSaveResponse> saveComment(@RequestBody CommentSaveRequest commentSaveRequest,@PathVariable Long cardId,@PathVariable Long workspaceId, @AuthenticationPrincipal AuthUser authUser) {
    ...
    public ResponseEntity<CommentUpdateResponse> updateComment(@RequestBody CommentUpdateRequest commentUpdateRequest, @PathVariable Long commentId,@PathVariable Long workspaceId, @AuthenticationPrincipal AuthUser authUser){
        Long userId = authUser.getUserId();  // 인증된 사용자의 ID 사용
    ...
    public ResponseEntity<Void> deleteComment(@PathVariable Long commentId, @PathVariable Long workspaceId,@AuthenticationPrincipal AuthUser authUser) {
        Long userId = authUser.getUserId();  // 인증된 사용자의 ID 사용
